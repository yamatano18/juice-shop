...
exports.isAuthorized = () => expressJwt({ algorithms: ['RS256'], secret: this.publicKey })
...
function hasValidFormat (coupon) {
  // return coupon.match(/(JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)[0-9]{2}-[0-9]/)
  return coupon.match('DEC20-10')
}
